...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-9 h-9 rounded-xl flex items-center justify-center bg-zinc-800 hover:bg-zinc-700 border border-white/10 transition-all"
    >
      {dark ? (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-zinc-300" viewBox="0 0 24 24" fill="currentColor">
